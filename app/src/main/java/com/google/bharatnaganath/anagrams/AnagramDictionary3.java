...
public class AnagramDictionary3 {
    ...
    public AnagramDictionary3(Reader reader) throws IOException {
    ...
    public String pickGoodStarterWord() {
        ...
        while (true) {
            ...
            ArrayList<String> sizeAl = (ArrayList) sizeToWords.get(wordLength); //To obtain a list of mentioned wordlength

            rnum = random.nextInt(sizeAl.size()) + 1;
            rword = sizeAl.get(rnum);
            ArrayList<String> tempal = (ArrayList) lettersToWord.get(sortLetters(rword)); //To find number of anagrams associated with letters
